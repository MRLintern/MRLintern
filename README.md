...
* Besides __Data Science__ and __Machine Learning__, I enjoy applying my skills to problems in __Scientific Software Engineering__, creating __Simulations__ and __Solvers__ using __Modern C++__, __C__ and __Fortran__.
...
* __University of Liverpool__: ___BSc(Hons) Geophysics with Physics___: __September 2009 - July 2012__.
  - __Thesis__: ___Secular Variation and Core-Surface Flow Modelling___.
      -  __Skills__: `Geomagnetism`, `Core Dynamics`, `Inverse Theory`, `Fortran`, `Numerical Methods` and `Fluid Dynamics`.
...
* ___Deep-Earth_HeatFlow___: A Modern __Fortran (2008+)__ solver, __Parallelising__ the __Jacobi Method__ with __OpenMP__ to model __Heat-Diffusion__ across the __Core-Mantle Boundary (CMB)__ of the __Earth__.
...
- [ParallelLinearNumerics: Modern C++ Software which uses OpenMP to Parallelise the 3 Classic Algebraic Iterative Methods: Jacobi, Gauss-Seidel and Successive Over Relaxation](https://github.com/MRLintern/Parallel_Linear_Solver). 
