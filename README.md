...
- ___hotFVM___. This is a solver developed with __C++__, which solves the __2D Heat/Diffusion Equation__. The __Discretization Method__ used will be the __Finite Volume Method (FVM)__. Everything else will be developed by myself.
