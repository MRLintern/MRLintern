...
- ___Parallel_Linear-Solvers___: __C++20__ __OOD__ software which utilises __OpenMP__ and the ___Red-Black Ordering Scheme__ to parallelise the __Jacobi__, __Gauss-Seidel__ and __Successive Over Relaxation (SOR)__ iterative methods. __Bench-Marking__, __Performance__ and __Convergence Rates__ are considered, and __matplotlib-cpp__ will be used to __Visualise Convergence__ using a __Python Script__. 
